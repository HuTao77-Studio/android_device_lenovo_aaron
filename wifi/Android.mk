...
include $(CLEAR_VARS)
LOCAL_MODULE := android.hardware.wifi@1.0-service-lazy.aaron.rc
...
include $(CLEAR_VARS)
LOCAL_MODULE := android.hardware.wifi@1.0-service.aaron.xml
LOCAL_MODULE_TAGS  := optional
LOCAL_MODULE_CLASS := ETC
...
include $(CLEAR_VARS)
LOCAL_MODULE := android.hardware.wifi@1.0-service-lazy.aaron
...
LOCAL_REQUIRED_MODULES := \
    android.hardware.wifi@1.0-service-lazy.aaron.rc \
    android.hardware.wifi@1.0-service.aaron.xml
